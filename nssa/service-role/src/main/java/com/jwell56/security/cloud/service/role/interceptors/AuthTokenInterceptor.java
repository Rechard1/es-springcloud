package com.jwell56.security.cloud.service.role.interceptors;
...
//            redisUtil.set("Authorization",claims.get("userJsonString", String.class),30*60);//30分钟
        	...
        	SysUser userObject = JSONObject.parseObject(
                    claims.get("userJsonString", String.class), new TypeReference<SysUser>() {});
