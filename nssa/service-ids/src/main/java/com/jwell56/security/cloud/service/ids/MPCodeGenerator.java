...
public class MPCodeGenerator {
    //数据库
    private static final String url = "jdbc:mysql://172.16.0.249:3306/ids_db?characterEncoding=utf8&useTimezone=true&serverTimezone=GMT%2B8&useSSL=false";
    private static final String driverName = "com.mysql.cj.jdbc.Driver";
    private static final String userName = "root";
    private static final String password = "ids_db_1qazZAQ!";

    //表名、表对应的基类名、类前缀
    private static final String[] table_name = new String[]{"sys_filed_setting"};

    //private static final String entityName = "Code";
    private static final String[] name_prex = new String[]{"sys"};
    //生成在该目录下
    ...
    public static void codeGenerator() {
        ...
        gc.setOutputDir(projectPath + "/service-ids/src/main/java");
        gc.setAuthor("wsg");
